...
total = 0
parity = input("Please choose odd or even parity: ").lower()
...
while bits != "":
    while len(bits) != 8 and bits != "":
        print("String length should be 8 symbols, it should consist of 0 and 1")
        bits = input("Please enter 8 bits: ")
    for item in bits:
        item = int(item)
        total += item
    if total % 2 == 0 and parity == "even":
        print(f"You have chosen even parity, the string you entered is {bits}, parity bit is 0")
    elif total % 2 != 0 and parity == "even":
        print(f"You have chosen even parity, the string you entered is {bits}, parity bit is 1")
    elif total % 2 == 0 and parity == "odd":
        print(f"You have chosen even parity, the string you entered is {bits}, parity bit is 1")
    elif total % 2 != 0 and parity == "even":
        print(f"You have chosen even parity, the string you entered is {bits}, parity bit is 1")
    bits = input("Please enter 8 bits: ")
